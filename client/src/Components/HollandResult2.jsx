...
import './HollandResults2.css'
import { useReactToPrint } from 'react-to-print';
import { Button } from 'primereact/button';
const HollandResults2 = () => {
    ...
    <Button 
        label="הורד PDF" 
        icon="pi pi-download" 
        className=" exclude-from-pdf p-button-raised p-button-rounded p-button-info"
        onClick={downloadPDF} 
    />
</div>
            ...
            <Link  to="/holland-info" className="exclude-from-pdf holland-link">
            ...
            <div className='exclude-from-pdf' style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '20px', width: '100%' }}>
                ...
                <div style={{ flexGrow: 1, maxWidth: '300px', alignSelf: 'flex-start' }}>
                    ...
                    <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'flex-end' }}>
                        <button className='exclude-from-pdf' style={{
                            padding: '10px 20px',
            ...
            <span className='exclude-from-pdf'>
            <Sidebar/>
            </span>
        </div>
    );
...
export default HollandResults2;