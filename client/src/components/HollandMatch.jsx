...
const HollandMatch = ({ title, percentage }) => {
    return (
        <div style={{ 
            ...
            margin: '10px auto',  // יישור למרכז
            padding: '20px', 
            backgroundColor: '#f9f9f9', 
            borderRadius: '8px', 
            border: '1px solid #e0e0e0',
            width: '80%', // רוחב דינמי שמתאים למסכים שונים
            maxWidth: '300px', // כדי שהקופסה לא תהיה רחבה מדי
            boxSizing: 'border-box' // טיפול נכון במרווחים ופדינג
        }}>
